...
def main(exp, args, num_gpu):
    ...
    *_, summary = evaluator.evaluate(
    ...
    if args.mot20:
        gtfiles = glob.glob(os.path.join('datasets/MOT20/prepare', '*/gt/gt{}.txt'.format(gt_type)))
    else:
        gtfiles = glob.glob(os.path.join('datasets/mot/prepare', '*/gt/gt{}.txt'.format(gt_type)))
