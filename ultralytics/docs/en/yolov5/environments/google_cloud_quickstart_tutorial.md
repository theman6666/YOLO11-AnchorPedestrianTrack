...
4.  Begin the [training process](../../modes/train.md) using your custom dataset YAML and potentially starting from pre-trained weights:
    ...
    python prepare.py --img 640 --batch 16 --epochs 100 --data custom_dataset.yaml --weights yolov5s.pt
    ```
...
gsutil cp -r ./runs/prepare/exp/weights gs://your-models-bucket/yolov5_custom_weights/
```
