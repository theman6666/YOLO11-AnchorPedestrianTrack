---
description: Learn how to run YOLO models for segmentation tasks with Ultralytics. Explore the SegmentationTrainer class and its functionalities.
keywords: YOLO, segmentation, run, Ultralytics, SegmentationTrainer, Python, machine learning, deep learning, tutorials
---
