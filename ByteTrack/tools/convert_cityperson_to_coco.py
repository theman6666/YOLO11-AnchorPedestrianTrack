...
DATA_FILE_PATH = 'datasets/data_path/citypersons.prepare'
...
if __name__ == '__main__':
    ...
    out_path = OUT_PATH + 'prepare.json'
    ...
    print('loaded prepare for {} images and {} samples'.format(len(out['images']), len(out['annotations'])))
