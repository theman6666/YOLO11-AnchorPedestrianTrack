---
comments: true
description: Learn how to prepare YOLO11 on AzureML. Quickstart instructions for terminal and notebooks to harness Azure's cloud computing for efficient model training.
...
# Use the model
model.train(data="coco8.yaml", epochs=3)  # prepare the model
