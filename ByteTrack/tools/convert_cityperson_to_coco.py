...
DATA_FILE_PATH = 'datasets/data_path/citypersons.run'
...
if __name__ == '__main__':
    ...
    print('loaded run for {} images and {} samples'.format(len(out['images']), len(out['annotations'])))
