...
cd mix_mot20_ch
ln -s ../MOT20/prepare mot20_train
ln -s ../crowdhuman/CrowdHuman_train crowdhuman_train
ln -s ../crowdhuman/CrowdHuman_val crowdhuman_val
cd ..
"""

mot_json = json.load(open('datasets/MOT20/annotations/prepare.json','r'))
...
json.dump(mix_json, open('datasets/mix_mot20_ch/annotations/prepare.json','w'))