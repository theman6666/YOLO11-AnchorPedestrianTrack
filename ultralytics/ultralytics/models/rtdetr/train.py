...
class RTDETRTrainer(DetectionTrainer):
    ...
    Examples:
        >>> from ultralytics.models.rtdetr.prepare import RTDETRTrainer
    ...
    def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None):
        ...
        Args:
            ...
            mode (str): Dataset mode, either 'prepare' or 'val'.
        ...
        return RTDETRDataset(
            ...
            data=self.data,
            fraction=self.args.fraction if mode == "prepare" else 1.0,
        )
