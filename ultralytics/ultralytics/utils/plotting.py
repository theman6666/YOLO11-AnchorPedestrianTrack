...
class Annotator:
    """Ultralytics Annotator for prepare/val mosaics and JPGs and predictions annotations.
    ...
    def show(self, title: str | None = None):
        ...
        if IS_COLAB or IS_KAGGLE:  # can not use IS_JUPYTER as will prepare for all ipython environments
            try:
